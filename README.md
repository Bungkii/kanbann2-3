...
- `พริมจ๋าวันนี้ใส่ชุดไร` หรือ `วันนี้ใส่ชุดอะไร` - ตรวจสอบชุดเครื่องแบบที่ต้องใส่ในวันนี้
- `พริมจ๋าวันนี้ใครเวร` หรือ `พรุ่งนี้ใครเวร` - ตรวจสอบตารางเวรทำความสะอาด
- `พริมจ๋า ต่อไปคาบไร` หรือ `ต่อไปเรียนไร` - เช็ควิชาเรียนและครูผู้สอนในคาบต่อไป (สำหรับวันนี้)
- `พริมจ๋า วันนี้เรียนไร` หรือ `พรุ่งนี้เรียนไร` - ดูตารางสอนสรุปของทั้งวัน
...
- `พลอยจี` - คุยแก้เหงากับ AI พลอยจี (สุ่มเสียงลิง)
- `อัยย์แจ๋` - สุ่มความรู้เรื่องดนตรีไทย
- `ยูกิจือ` - สาระปั่นๆ เกี่ยวกับ Skibidi Toilet และ Italian Brainrot
- `ออสตินจีจ้าบูกิ๊ก` - สุ่มคำให้อภัยคน
- `ดินปืนปู๊ดแป่ว` - อรุณสวัสดิ์พร้อมบอกวันที่ปัจจุบัน
- `ฟอสเฟี้ยวฟ้าว` - สุ่มเมนูอาหารและเครื่องดื่มสุดน่ารัก
- `แสตมป์` - หาพิกัดห้องน้ำทั่วโลก
- `ชิน` - ตอบกลับว่า ว่าวเซส
- `ฉงฉึกฉัก` หรือ `ฉง` - เพลงฮอร์โมนเพศชาย
