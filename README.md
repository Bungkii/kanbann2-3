...
### 7. 📅 ตารางสอนของห้อง 3 (Room 3 Timetable)
- ตารางเรียนรวมทั้งสัปดาห์ (ม.2/3) คาบที่ 1 ถึง 8 พร้อมแถบพักกลางวัน (11:40 - 12:30 น.)
- **ไฮไลท์สีเหลืองแนวตรง:** ไฮไลท์คอลัมน์คาบเรียนปัจจุบันแบบเรียลไทม์ และไฮไลท์ช่องวิชาที่กำลังเรียนอยู่
- ซิงค์ข้อมูลแบบ Realtime กับระบบหลังบ้าน (`/settings/schedule`)
- รองรับมุมมองรายวัน (Cards View) พร้อมสีประจำวัน และปุ่มคัดลอกตารางเรียนเพื่อแชร์ลงกลุ่ม LINE

### 8. ⚙️ ระบบหลังบ้าน (Admin Settings)
- **ตั้งค่าระบบพริมจ๋า:** 
...
- `ถาพัดจัดให้` - สุ่มคำถามทำความรู้จักตัวเอง 214 ข้อ พร้อมบันทึกคำตอบลงระบบ
- `ตอบถาพัด: <คำตอบ>` - ใช้สำหรับบันทึกคำตอบจากระบบสุ่มคำถาม
- `พริมจ๋า ส่งโพลล่าสุด` - ดึงโพลที่สร้างไว้ล่าสุดบนหน้าเว็บมาให้เพื่อนโหวต (ประหยัดโควต้า Push)
