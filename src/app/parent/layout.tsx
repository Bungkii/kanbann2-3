...
export const metadata: Metadata = {
  ...
  title: {
    default: 'ระบบติดตามงานและการบ้านห้อง ม.2/3 | สำหรับผู้ปกครอง',
    template: '%s | ผู้ปกครอง ม.2/3'
  },
  description: 'ติดตามการบ้าน งานค้าง กองทุนห้อง และเตรียมตัวสอบของนักเรียนชั้น ม.2/3 (พริมจ๋า) สำหรับผู้ปกครอง',
  keywords: [
    "พริมจ๋า",
    "พริมจ๋า ม.2/3",
    "ห้อง 3",
  ...
  openGraph: {
    ...
    title: "ระบบติดตามงานและการบ้านห้อง ม.2/3 | สำหรับผู้ปกครอง",
    description: "ติดตามการบ้าน งานค้าง กองทุนห้อง และเตรียมตัวสอบของนักเรียนชั้น ม.2/3",
    siteName: "กระดานผู้ปกครอง ม.2/3",
    images: [{ url: "/logo.png", width: 512, height: 512, alt: "ผู้ปกครอง ม.2/3" }],
  },
};
