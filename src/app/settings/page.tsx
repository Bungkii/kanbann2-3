          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link href="/settings/roles" className="group">
              <div className="bg-slate-50 border border-slate-100 rounded-2xl p-8 flex flex-col items-center text-center h-full transition-all hover:bg-rose-50 hover:border-rose-100 hover:shadow-sm">
                ...
                <h2 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-rose-700">จัดการสิทธิ์ (Roles)</h2>
                <p className="text-sm text-slate-500">กำหนดคนเป็น Admin, คนทวงเงิน หรือคนจดงาน</p>
              </div>
            </Link>
